...
Ent1 = Entry(window, bd=2, justify="center", bg="red")
Ent1.grid(row=0, column=0)
Ent1.insert(0, "row 0, column 0")

Ent2 = Entry(window, bd=2, justify="center", bg="red")
Ent2.grid(row=0, column=1)
Ent2.insert(0, "row 0, column 1")

Ent3 = Entry(window, bd=2, justify="center", bg="red")
...
Ent7 = Entry(window, bd=2, justify="center", bg="blue")
Ent7.grid(row=2, column=0)
Ent7.insert(0, "row 2, column 0")

Ent8 = Entry(window, bd=2, justify="center", bg="blue")
Ent8.grid(row=2, column=1)
Ent8.insert(0, "row 2, column 1")

Ent9 = Entry(window, bd=2, justify="center", bg="blue")
